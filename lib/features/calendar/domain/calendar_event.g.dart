...
const CalendarEventSchema = CollectionSchema(
  ...
  idName: r'id',
  indexes: {
    r'sortKey': IndexSchema(
      id: 1095463272929437710,
      name: r'sortKey',
      unique: false,
      replace: false,
      properties: [
...
void _calendarEventSerialize(
  ...
  writer.writeDateTime(offsets[3], object.sortKey);
...
extension CalendarEventQueryWhereSort
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhere> anySortKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'sortKey'),
      );
    });
  }
}
...
extension CalendarEventQueryWhere
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhereClause> sortKeyEqualTo(
      DateTime sortKey) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhereClause>
      sortKeyNotEqualTo(DateTime sortKey) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhereClause> sortKeyLessThan(
    DateTime sortKey, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhereClause> sortKeyBetween(
    DateTime lowerSortKey,
    DateTime upperSortKey, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension CalendarEventQueryFilter
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition> typeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension CalendarEventQuerySortBy
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByDateTime() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByIsDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.asc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByIsDoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.desc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByPayloadJson() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortBySortKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortKey', Sort.asc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortBySortKeyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CalendarEventQuerySortThenBy
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByDateTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateTime', Sort.asc);
    });
  }
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByIsDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.asc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByIsDoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.desc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByPayloadJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'payloadJson', Sort.asc);
    });
  }
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenBySortKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortKey', Sort.asc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenBySortKeyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortKey', Sort.desc);
    });
  }
...
extension CalendarEventQueryWhereDistinct
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByDateTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'dateTime');
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByIsDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isDone');
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByPayloadJson(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctBySortKey() {
    return QueryBuilder.apply(this, (query) {
...
extension CalendarEventQueryProperty
  ...
  QueryBuilder<CalendarEvent, DateTime, QQueryOperations> dateTimeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'dateTime');
    });
  }

  QueryBuilder<CalendarEvent, bool, QQueryOperations> isDoneProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isDone');
    });
  }

  QueryBuilder<CalendarEvent, String?, QQueryOperations> payloadJsonProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'payloadJson');
    });
  }

  QueryBuilder<CalendarEvent, DateTime, QQueryOperations> sortKeyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'sortKey');
    });
  }

  QueryBuilder<CalendarEvent, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
